...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $upload   = $_POST['upload_evidence'];
    $desc     = $_POST['case_description'];

    $sql = "INSERT INTO report_case (full_name, email, pollution_type,location, date_of_incident, upload_evidence, case_description, created_at) 
         VALUES ('$name', '$email', '$type', '$location', '$date','$upload','$desc', NOW())";
...
// Fetch all reports
$result = $conn->query("SELECT * FROM report_case ");
...
<div class="container mt-4">
  <h2 class="text-center text-primary">📢 Report a Pollution Case</h2>
  <?php echo $message; ?>

  <!-- Reports Table -->
  <h3 class="mt-5 text-success">📊 Submitted Reports</h3>
